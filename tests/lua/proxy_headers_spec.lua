describe("Phase 2 routing and audit configuration", function()
    ...
    it("runs policy and body filters on all inbound paths", function()
        ...
        assert.equals(3, policy_count)
        -- 3 inbound (LLM, Bedrock models, MCP) plus 3 outbound ledger locations.
        assert.equals(6, body_filter_count)
        assert.equals(3, log_phase_count)
