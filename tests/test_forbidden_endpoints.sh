...
CONTAINER_NAME="${PROVOST_CONTAINER:-llm-provost}"
...
# The outbound MCP-to-API ledger (port 8081) lives on the llm-provost container.
url = f"http://llm-provost:8081{route_prefix}{target_path}"
data = b"{}"
headers = {
